...
<div class="modal">
    <div class="modal__content">
        <form action="" method="">
            ...
            <div>
                <input type="number"  placeholder="Código cuadrilla" id="codecuadrilla" name="codecuadrilla" required>
            </div>
            <div>
                <input type="text"  placeholder="Metraje Realizado" id="metrajerealizado" name="metrajerealizado" required>
            </div>
            <div>
                <input type="text"  placeholder="Rendimiento" id="rendimiento" name="rendimiento" required>
            </div>
            <div>
                <input type="text"  placeholder="Consumo" id="consumo" name="consumo" required>
            </div>
            <div>
                <input type="text"  placeholder="Observación" id="observacion" name="observacion" required>
            </div>
...
<div class="regmanoobra">
    <div class="modal__content">
        <form action="" method="">
            <p>Registrar mano de obra</p>
            <div>
                <input type="date"  placeholder="Fecha" id="fecharegmanoobra" name="fecharegmanoobra" required>
            </div>
            <div>
                <input type="text"  placeholder="Ubicación" id="ubicacionregmanoobra" name="ubicacionregmanoobra" required>
            </div>
            <div>
                <input type="text"  placeholder="Cuadrilla" id="Cuadrillaregmanoobra" name="Cuadrillaregmanoobra" required>
            </div>
            <div>
                <input type="text"  placeholder="Metraje Realizado" id="metrajerealizado" name="metrajerealizado" required>
            </div>
            ...
            <button class="btn-red" type="submit">Agregar</button>
            <button class="btn-gris" type="reset">Borrar información</button>
            <i class="fas fa-times-circle cerrarreg"></i>
        </form>
    </div>
</div>
<div class="editar">
        ...
        <div class="vista-proyecto__right">
            <div class="vista-proyecto__right__content">
                ...
                <div class="opciones-manoDeobra">
                    ...
                    <a class="abrirreg" href="">Registro de mano de obra</a>
                </div>
                ...
                <div class="vista-proyecto__table">
                    <div class="opciones-proyecto">
                        <div class="add-actividad">
                            ...
                            <p class="abrir">Agregar cuadrilla</p>
                        </div>
...
<script src="<?= URL ?>public/js/reg.js"></script>
