...
<div class="modal">
    <div class="modal__content">
        <form action="" method="">
            ...
            <div>
                <input type="text"  placeholder="Responsable" id="responsable" name="responsable" required>
            </div>
        ...
        <div>
            <div class="agregar-proyecto">
                <div class="detalles-proyecto__content agregar-proyecto__content">
                    <div class="agregar-proyecto__title">
                        <p class="abrir">Agregar proyecto</p>
            ...
            <div class="detalles-proyecto">
                <div class="detalles-proyecto__content">
                    ...
                    <div class="acciones-proyecto">
                        ...
                        <a href="<?= URL ?>index/Proyecto">Visualizar</a>
                    </div>
                </div>
            </div>
        </div>
